...
public class StandardAnnotationMetadata extends StandardClassMetadata implements AnnotationMetadata {
	 ...
	 * 为给定的类创建一个新的{@link StandardAnnotationMetadata}包装器，并提供以{@link org.springframework.core.annotation.AnnotationAttributes}而不是实际的{@link Annotation}形式返回任何嵌套注释或注释数组的实例。
	 * @param introspectedClass the Class to introspect
