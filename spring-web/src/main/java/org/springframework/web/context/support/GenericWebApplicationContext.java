 ...
 * but is not intended for declarative setup in {@code web.xml}. Instead 反而, it is designed
 ...
 * from configuration files 如果打算实现从配置文件读取Bean定义的WebApplicationContext,
 * consider deriving from AbstractRefreshableWebApplicationContext,
 * reading the bean definitions in an implementation of the {@code loadBeanDefinitions}
 * method.</b>
 *
 * <p>Interprets resource paths as servlet context resources, 将资源路径解释为Servlet 容器 资源 i.e. as paths beneath
...
public class GenericWebApplicationContext extends GenericApplicationContext
	...
	/**
	 * Register ServletContextAwareProcessor. 注册 web 容器感知处理器
