 ...
 * 此GenericBeanDefinition变体主要用于测试希望在AnnotatedBeanDefinition上运行的代码，例如Spring的组件扫描支持中的策略实现（默认定义类为{@link org.springframework.context.annotation.ScannedGenericBeanDefinition}，该实现也实现了）AnnotatedBeanDefinition接口）。
...
public class AnnotatedGenericBeanDefinition extends GenericBeanDefinition implements AnnotatedBeanDefinition {
	 ...
	 * 为指定的bean class 创建一个 新的 AnnotatedGenericBeanDefinition
